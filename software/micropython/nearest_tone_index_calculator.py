...
def computation(self):
    ...
    for notes_per_led in self.notes_per_led_options:
        result[str(notes_per_led)]=[self.notes[i:i+notes_per_led] for i in range(0,len(self.notes),notes_per_led)]#segment the calculated above list
...
# storage = PrecomputedValues('utils/binned_idexes_represent_which_musical_tones.json')
